...
public class DanceEventAdapter extends RecyclerView.Adapter<DanceEventAdapter.ViewHolder> {
private ArrayList<DanceEventList> arrayList;
private Context context;
public DanceEventAdapter(ArrayList arrayList,Context context){
        this.arrayList=arrayList;
        this.context=context;
        }
@NonNull
@Override
public DanceEventAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater=LayoutInflater.from(parent.getContext());
        View list = layoutInflater.inflate(R.layout.danceevent_list,parent,false);
...
@Override
public void onBindViewHolder(@NonNull DanceEventAdapter.ViewHolder holder, int position) {
final DanceEventList danceList=arrayList.get(position);
