...
public class MicEventAdapter extends RecyclerView.Adapter<MicEventAdapter.ViewHolder> {
    private ArrayList<MicEventList> arrayList;
    private Context context;
    public MicEventAdapter(ArrayList arrayList,Context context){
        this.arrayList=arrayList;
        this.context=context;
    }
    @NonNull
    @Override
    public MicEventAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater=LayoutInflater.from(parent.getContext());
        View list = layoutInflater.inflate(R.layout.micevent_list,parent,false);
    ...
    @Override
    public void onBindViewHolder(@NonNull MicEventAdapter.ViewHolder holder, int position) {
        final MicEventList danceList=arrayList.get(position);
