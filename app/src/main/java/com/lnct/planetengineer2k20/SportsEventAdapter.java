...
public class SportsEventAdapter extends RecyclerView.Adapter<SportsEventAdapter.ViewHolder> {
    private ArrayList<SportsEventList> arrayList;
    private Context context;
    public SportsEventAdapter(ArrayList arrayList,Context context){
        this.arrayList=arrayList;
        this.context=context;
    }
    @NonNull
    @Override
    public SportsEventAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater=LayoutInflater.from(parent.getContext());
        View list = layoutInflater.inflate(R.layout.sportsevent_list,parent,false);
    ...
    @Override
    public void onBindViewHolder(@NonNull SportsEventAdapter.ViewHolder holder, int position) {
        final SportsEventList danceList=arrayList.get(position);
