...
public class ColorEventAdapter extends RecyclerView.Adapter<ColorEventAdapter.ViewHolder> {
    private ArrayList<ColorEventList> arrayList;
    private Context context;
    public ColorEventAdapter(ArrayList arrayList,Context context){
        this.arrayList=arrayList;
        this.context=context;
    }
    @NonNull
    @Override
    public ColorEventAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater=LayoutInflater.from(parent.getContext());
        View list = layoutInflater.inflate(R.layout.colorevent_list,parent,false);
    ...
    @Override
    public void onBindViewHolder(@NonNull ColorEventAdapter.ViewHolder holder, int position) {
        final ColorEventList danceList=arrayList.get(position);
