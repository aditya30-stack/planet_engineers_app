...
public class TechnicalEventAdapter extends RecyclerView.Adapter<TechnicalEventAdapter.ViewHolder> {
    private ArrayList<TechnicalEventList> arrayList;
    private Context context;
    public TechnicalEventAdapter(ArrayList arrayList,Context context){
        this.arrayList=arrayList;
        this.context=context;
    }
    @NonNull
    @Override
    public TechnicalEventAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater=LayoutInflater.from(parent.getContext());
        View list = layoutInflater.inflate(R.layout.technicalevent_list,parent,false);
    ...
    @Override
    public void onBindViewHolder(@NonNull TechnicalEventAdapter.ViewHolder holder, int position) {
        final TechnicalEventList danceList=arrayList.get(position);
