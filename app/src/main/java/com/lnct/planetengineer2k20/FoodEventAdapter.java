...
public class FoodEventAdapter extends RecyclerView.Adapter<FoodEventAdapter.ViewHolder> {
    private ArrayList<FoodEventList> arrayList;
    private Context context;
    public FoodEventAdapter(ArrayList arrayList,Context context){
        this.arrayList=arrayList;
        this.context=context;
    }
    @NonNull
    @Override
    public FoodEventAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater=LayoutInflater.from(parent.getContext());
        View list = layoutInflater.inflate(R.layout.foodevent_list,parent,false);
    ...
    @Override
    public void onBindViewHolder(@NonNull FoodEventAdapter.ViewHolder holder, int position) {
        final FoodEventList danceList=arrayList.get(position);
