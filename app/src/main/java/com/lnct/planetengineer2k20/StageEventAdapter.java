...
public class StageEventAdapter extends RecyclerView.Adapter<StageEventAdapter.ViewHolder> {
    private ArrayList<StageEventList> arrayList;
    private Context context;
    public StageEventAdapter(ArrayList arrayList,Context context){
        this.arrayList=arrayList;
        this.context=context;
    }
    @NonNull
    @Override
    public StageEventAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater=LayoutInflater.from(parent.getContext());
        View list = layoutInflater.inflate(R.layout.stageevent_list,parent,false);
    ...
    @Override
    public void onBindViewHolder(@NonNull StageEventAdapter.ViewHolder holder, int position) {
        final StageEventList danceList=arrayList.get(position);
