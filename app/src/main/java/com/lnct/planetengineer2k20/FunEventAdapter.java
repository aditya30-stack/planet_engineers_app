...
public class FunEventAdapter extends RecyclerView.Adapter<FunEventAdapter.ViewHolder> {
    private ArrayList<FunEventList> arrayList;
    private Context context;
    public FunEventAdapter(ArrayList arrayList,Context context){
        this.arrayList=arrayList;
        this.context=context;
    }
    @NonNull
    @Override
    public FunEventAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater=LayoutInflater.from(parent.getContext());
        View list = layoutInflater.inflate(R.layout.funevent_list,parent,false);
    ...
    @Override
    public void onBindViewHolder(@NonNull FunEventAdapter.ViewHolder holder, int position) {
        final FunEventList danceList=arrayList.get(position);
