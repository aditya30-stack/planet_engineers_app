...
import com.lnct.planetengineer2020.ui.home.HomeFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                R.id.nav_visitwebsite, R.id.nav_emergencycontact, R.id.nav_rateus,
                R.id.nav_developerzone, R.id.nav_events)
